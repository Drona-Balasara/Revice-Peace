...
var Meditation = function(){
	...
	var homeSearch = function() {
		...
		quikSearch.on('click',function() {
			jQuery('.rdx-quik-search').fadeIn(500);
			jQuery('.rdx-quik-search').addClass('On');
		});
		
		quikSearchRemove.on('click',function() {
			jQuery('.rdx-quik-search').fadeOut(500);
			jQuery('.rdx-quik-search').removeClass('On');
		});
	...
	var appoinmentForm = function (){
		'use strict';
		jQuery("#appointment_form").submit(function(e)
		{
			jQuery('#show_appoinment_msg').show();
			jQuery('#show_appoinment_msg').html('<div class="gen alert alert-success">Submitting..</div>');
